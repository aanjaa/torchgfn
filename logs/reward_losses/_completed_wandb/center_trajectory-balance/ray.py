...
if __name__ == "__main__":
    ...
    def run_hypergrid_experiment(experiment_name):
        ...
        if experiment_name == "reward_losses":
            ...
            for loss_name in [ "trajectory-balance", "sub-tb"]:#LOSS_NAMES:
        ...
        ## EXPERIMENT 2: Which loss for higher ndim and height?
            ...
            for loss_name in ["detailed-balance", "trajectory-balance"]:#LOSS_NAMES:
    ...
    experiments = ["searchspaces_losses"]
    #experiments = ["reward_losses"]
